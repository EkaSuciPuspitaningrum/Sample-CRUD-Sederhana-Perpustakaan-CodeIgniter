...
<body class="text-center">
    ...
    <main class="form-signin">
        ...
        <form method="post" action="<?= base_url(); ?>/User/prosesDaftar">
            <?= csrf_field(); ?>
            <h1 class="h1 mb-3 fw-normal">Silahkan Masukkan Data Diri</h1>
            <h1 class="h4 mb-3 fw-normal">Untuk Mendaftarkan Diri Sebagai Pengguna</h1>
            ...
            <a href="<?= base_url('loginUser')?>" role="button" class="w-100 btn btn-lg btn-warning" type="submit">Masuk</a>
