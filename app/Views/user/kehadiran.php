...
<body class="text-center">
    ...
    <?php if (!empty(session()->getFlashdata('error'))) : ?>
        ...
        <?php endif;?>
    <form method="post" action="<?= base_url(); ?>/Hadir/prosesHadir">
            <?= csrf_field(); ?>
            <h1 class="h1 mb-3 fw-normal">Silahkan Masukkan Data Diri</h1>
            <h1 class="h4 mb-3 fw-normal">Untuk Melanjutkan Ke Halaman Pengguna</h1>
    ...
    <script src="<?= base_url('js/sidebars.js') ?>"></script>
